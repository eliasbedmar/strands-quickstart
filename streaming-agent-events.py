...
# 2 Methods for streaming responses:
# 1 - agent.stream_async(prompt) # Returns an async iterator (note Async Invocator also available)
# 2 - agent.stream(prompt) # Returns a list of events


###########
# Async Iterator - note Async Invocator also available
###########
...
result = agent( "What is 25 * 48 and explain the calculation")
